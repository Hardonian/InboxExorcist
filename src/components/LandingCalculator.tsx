      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center">
        <div>
          <span className="text-xs font-semibold uppercase tracking-wider text-amber-400">
            Inbox ROI Calculator
          </span>
          <h2 className="mt-2 text-3xl font-bold text-white sm:text-4xl">
            How much time are promo demons costing you?
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-zinc-300">
            The average Gmail inbox is 60-70% automated marketing noise. Adjust the slider to estimate how many hours and mental energy you will reclaim with InboxExorcist.
          </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-2xl border border-white/10 bg-zinc-900/90 p-5">
            ...
            <div className="mt-2 font-mono text-4xl font-extrabold text-amber-400">
              {hoursSavedPerMonth} hrs
            </div>
            <div className="mt-1 text-xs text-zinc-400">Reclaimed personal focus</div>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-zinc-900/90 p-5">
            <div className="text-xs font-medium text-zinc-400">Inbox Noise Reduction</div>
            <div className="mt-2 font-mono text-3xl font-extrabold text-emerald-400">
              ~65%
            </div>
            <div className="mt-1 text-xs text-zinc-400">Immediate clutter reduction</div>
          </div>

          <div className="rounded-2xl border border-white/10 bg-zinc-900/90 p-5">
            <div className="text-xs font-medium text-zinc-400">Important Emails Lost</div>
            <div className="mt-2 font-mono text-3xl font-extrabold text-white">
              0
            </div>
            <div className="mt-1 text-xs text-emerald-400">100% Protected Safe Skips</div>
          </div>
        </div>
      </div>
    </div>
